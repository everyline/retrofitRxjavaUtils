 ...
 * 创建时间：2019/8/1
 */
public class UniversalPopWindow implements PopupWindow.OnDismissListener {
    ...
    private UniversalPopWindow(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public UniversalPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public UniversalPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public UniversalPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public UniversalPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
    ...
    public static class PopupWindowBuilder{
        private UniversalPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new UniversalPopWindow(context);
        }
        ...
        public UniversalPopWindow create(){
            //构建PopWindow
